            ...
            <div className="grid">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-5 mt-10 gap-y-8 gap-x-4 text-[0.85rem]">
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <Link
                            href="/whats-yours-ethos"
                            className="underline text-white"
                        >
                            What's your Ethos? Podcast
                        </Link>
                    </div>
                    <div className="flex flex-col gap-2">
                ...
                <p className="text-[0.7rem] mt-10 text-white sm:hidden lg:block lg:mt-20">
                    © 2023 Ethos Technologies Inc. Ethos operates in some states
                    as Ethos Life Insurance Services. CA license #0L28949; AR
                    license #100164629. Ethos offers policies issued by the
                    carriers listed at{" "}
                    <Link href="www.ethoslife.com/carriers.">
                        www.ethoslife.com/carriers.
                    </Link>
                ...
                <div className="hidden sm:flex mt-14 gap-24 lg:hidden">
                    ...
                    <p className="text-[0.7rem] mt-10 text-white">
                        © 2023 Ethos Technologies Inc. Ethos operates in some
                        states as Ethos Life Insurance Services. CA license
                        #0L28949; AR license #100164629. Ethos offers policies
