        ...
        <div className="flex gap-12 sm:mt-20 lg:mt-24 lg:items-center w-full sm:gap-16 text-[#323232] flex-col px-8 lg:px-14 sm:px-12 mt-8 justify-center">
            ...
            <div className="gap-10 grid w-full 2xl:w-[65%] 2md:gap-y-0 lg:items-center 2md:grid-cols-2">
                ...
                <div className="max-w-[550px] 2md:py-6">
                    ...
                    <p className="text-lg mt-1 text-[#323232]">
                        Minalife's policies are backed by industry giants with a
                        long history of financial strength and stability. You
                        can trust that your policy will withstand the test of
                        time, while enjoying the simplicity and ease of use of a
                        modern tech company.
                    </p>
                </div>
                <div className="max-w-[550px] 2md:border-r 2md:pr-4 2md:py-6">
                    ...
                    <p className="text-lg mt-1 text-[#323232]">
                        ...
                        free, with no impact on your credit score. Each policy
                        comes with a 30-day free look period and a money-back
                        guarantee. You can cancel your policy at any time, with
                        no fees or penalties.
                    </p>
                </div>
                <Link href='/faq' className="hover:underline font-medium ">More faqs <ArrowForwardIcon/></Link>
            </div>
        </div>
    );
};
