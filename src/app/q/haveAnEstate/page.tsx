            ...
            <div>
                ...
                <div className="flex flex-col px-6 py-8 sm:items-center">
                    ...
                    <p className="text-gray-800 mt-6 max-w-[578px] mb-4">
                        It might just be a car and a house - or it might be
                        something much bigger. Either way, it’s your estate.
                    </p>
                    <Image src="/your-estate.svg" alt="estate" height={500} width={500} className="mt-4"/>
                    <Link
                        href="/q/epgOverview"
